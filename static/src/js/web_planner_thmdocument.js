odoo.define('planner_thmdocument.planner', function (require) {
"use strict";
...
planner.PlannerDialog.include({
    prepare_planner_event: function() {
        ...
        if(self.planner['planner_application'] == 'planner_thmdocument') {
            var stages = {
                'development_process': {
            ...
            self.$( ".user_thmdocument" ).on('change', function() {
