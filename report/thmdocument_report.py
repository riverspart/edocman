...
class ReportThmdocumentTaskUser(models.Model):
    _name = "report.thmdocument.task.user"
    _description = "Tasks by user and thmdocument"
    _order = 'name desc, thmdocument_id'
    _auto = False
    ...
    thmdocument_id = fields.Many2one('thmdocument.thmdocument', string='Thmdocument', readonly=True)
    ...
    stage_id = fields.Many2one('thmdocument.task.type', string='Stage', readonly=True)
